...
<body>
	...
	<form action="submitServlet"  method="post">
    	<div class="contentCenter">
    			...
    			<div class="twoDiv">
					...
					<ul class="oneUL">
    					<li>
    						...
    						<p>计算机&nbsp;&nbsp;JAVA&nbsp;&nbsp;${item.value.book.name }&nbsp;&nbsp;</p>
    		...
    		<div class="money">
    			<span><font>${sessionScope.cart.size() }</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${sessionScope.cart.totalPrice() }</span>
    			<span><img src="images/sureLogo_18.png" alt="">运费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥0.00</span>
    			
    			<span>应付总额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${sessionScope.cart.totalPrice() }</span>
    		</div>
    		<div class="submit">
    			<span>实付金额：<font>¥${sessionScope.cart.totalPrice() }</font></span>
